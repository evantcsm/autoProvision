...
emailAddress += "example"+i+"@gmail.com";    // email template that we will use and iterate a number for i. 
userName += "Test User+"+i;                    // username template that we will use and iterate a number for i. 
